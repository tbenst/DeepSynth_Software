...
from data.base_dataset import BaseDataset, get_transform, get_transform_noflip
...
class UnalignedDataset(BaseDataset):
    def initialize(self, opt):
        ...
        self.transform_noflip = get_transform_noflip(opt)
    ...
    def __getitem__(self, index):
        ...
        A = self.transform_noflip(A_img)
        C = self.transform_noflip(C_img)
