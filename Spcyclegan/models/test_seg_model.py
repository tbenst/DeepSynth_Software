...
class TestModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        self.netG = networks.define_G(opt.input_nc, opt.output_nc, opt.ngf, 'resnet_seg', opt.norm, not opt.no_dropout, opt.init_type, self.gpu_ids)
    ...
    def test(self):
        ...
        self.fake_B, seg = self.netG(self.real_A)
