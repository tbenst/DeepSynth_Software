...
class CycleGANModel(BaseModel):
    ...
    def backward_G(self):
        ...
        # location loss
        loss_location = torch.nn.MSELoss()(seg, self.real_A) * lambda_C
        ...
        # combined loss
        loss_G = loss_G_A + loss_G_B + loss_cycle_A + loss_cycle_B + loss_idt_A + loss_idt_B + loss_location
        loss_G.backward()
        ...
        self.loss_location = loss_location.data
    ...
    def get_current_errors(self):
        ret_errors = OrderedDict([('D_A', self.loss_D_A), ('G_A', self.loss_G_A), ('Cyc_A', self.loss_cycle_A),
                                 ...
                                 ('location',  self.loss_location),('total',self.loss_G)])
